...
return [
    "text:home-header.title" => i::__("Boas-vindas ao Mapa Cultural da AMAUC"),
    "text:home-header.description" => i::__("O Mapa Cultural da AMAUC é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores."),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa Cultural da AMAUC"),
    "text:home-register.description" => i::__("Contribua com a plataforma livre e interativa de mapeamento do cenário cultural e instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas culturais promovidas."),
    'text:home-developers.description' => 'Além disso, Mapa cultural da AMAUC é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
